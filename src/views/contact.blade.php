  ...
  <div class="container">
    ...
    <form action="{{ route('contact.send') }}" method="POST">
      ...
      <div class="form-group">
        ...
        <input type="number" class="form-control" name="userphone" id="userphone" placeholder="Enter your phone number" required >
      </div>
      <div class="form-group">
        <label for="usercountry">Country:</label>
        <select class="form-control" name="usercountry" id="usercountry" required>
